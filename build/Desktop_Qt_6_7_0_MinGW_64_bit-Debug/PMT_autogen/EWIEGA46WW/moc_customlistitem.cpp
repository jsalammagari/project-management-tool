...
constexpr auto qt_meta_stringdata_CLASSCustomListItemENDCLASS = QtMocHelpers::stringData(
    "CustomListItem",
    "createStoryClicked",
    "",
...
Q_CONSTINIT const QMetaObject CustomListItem::staticMetaObject = { {
    ...
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSCustomListItemENDCLASS_t,
        ...
        // method 'createStoryClicked'
        QtPrivate::TypeAndForceComplete<void, std::false_type>,
        // method 'onCreateStoryClicked'
        QtPrivate::TypeAndForceComplete<void, std::false_type>
    >,
    nullptr
} };
...
void CustomListItem::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->createStoryClicked(); break;
        case 1: _t->onCreateStoryClicked(); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (CustomListItem::*)();
            if (_t _q_method = &CustomListItem::createStoryClicked; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void CustomListItem::createStoryClicked()
{
